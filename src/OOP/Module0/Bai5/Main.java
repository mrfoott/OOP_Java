...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            HangThucPham hang1 = new HangThucPham("1", "Gao", 100000f, LocalDate.of(2020, 7, 10), LocalDate.of(2023, 7, 10));
            HangThucPham hang2 = new HangThucPham("2", "Mi", 5000f, LocalDate.of(2020, 5, 22), LocalDate.of(2023, 11, 22));
